					...
					<>
						<div className="my-2 text-dark">
                            <li className='d-flex rounded shadow-lg px-4' style={{backgroundColor:"rgb(10, 10, 292)"}}>
                                <li className="col-1 py-2" id='list'>{index + 1}</li>
                                <li className="col-3 py-2" id='list'>{input.myInput}</li>
