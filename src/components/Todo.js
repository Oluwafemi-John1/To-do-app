...
const Todo = ({myInput,setMyInput,myTodo,setMyTodo,myDate,myTime}) => {
  ...
  return (
        ...
        <section className='row'>
			<div className="col-lg-3 shadow rounded-5 px-2 mx-lg-5" id='topdiv'>
                <div className="py-lg-5 mx-auto">
                    <h3 className='text-center mb-lg-5 mt-2'>To Do</h3>
							...
							<div className="modal-dialog">
								<div className="modal-content">
									...
									<div className="modal-body">
										<input type="text" className="form-control" value={editTodos} maxLength={15} onChange={(e) => seteditTodos(e.target.value)}
										/>
									</div>
